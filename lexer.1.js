      ...
      if (c === '/') {
        ...
        if (next_c === '/') {
          ...
          // return {name: 'DIVIDE', value: '/', pos: this.pos++};
            this.listOfTokens.push({name: 'DIVIDE', value: '/', pos: this.pos++});
        }
      } else {
        ...
        if (op !== undefined) {
          ...
          this.listOfTokens.push({name: op, value: c, pos: this.pos++});
        } else {
...
//       list.push({name:'keyword' , value: str});
//       isKeyword = true;
//       str='';
//     }
//   });
...
//   this.pos = endpos;
//   this.listOfTokens.push(list);
  
}

/*this method is for parser project */
/*_process_identifier () {
  let list = [];
